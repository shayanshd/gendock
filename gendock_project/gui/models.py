...
class ReceptorConfiguration(models.Model):
    ...
    center_x = models.DecimalField(max_digits=10, decimal_places=5, default=0)
    size_x = models.DecimalField(max_digits=10, decimal_places=5, default=30)
    center_y = models.DecimalField(max_digits=10, decimal_places=5, default=0)
    size_y = models.DecimalField(max_digits=10, decimal_places=5, default=30)
    center_z = models.DecimalField(max_digits=10, decimal_places=5, default=0)
    size_z = models.DecimalField(max_digits=10, decimal_places=5, default=30)
